...
| F6.4 | System shall automatically catoragise tasks based on content | High | e.g "study" -> Education category| 
| F6.5 | System shall allow users to review and confirm parsed tasks before saving | High | Prevents categorisation and language interpretation errors.
